...
class LearnerUser(Base):
    ...
    selected_level: Mapped[str] = mapped_column(String(32), default="A1", index=True)
    preferred_topic: Mapped[str | None] = mapped_column(String(120), index=True)
...
class WordItem(Base):
    ...
    collection: Mapped[str] = mapped_column(String(160), default="Daily Vocabulary", index=True)
    tags: Mapped[str] = mapped_column(Text, default="")
    collocations: Mapped[str] = mapped_column(Text, default="")
